describe('App', function () {
  ...
  it('should have a title', function () {
    expect(browser.getTitle()).toEqual('Wcmv3demo app | ACPaaS Angular 2 generator');
  });
  ...
  it('should have a main title', function () {
    expect(element(by.css('main h1')).getText()).toEqual('Digipolis Angular2 Wcmv3demo App');
  });
